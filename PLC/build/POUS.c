...
void WATERIRRIGATION_init__(WATERIRRIGATION *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->PULSE,__time_to_timespec(1, 10000, 0, 0, 0, 0),retain)
}
...
void WATERIRRIGATION_body__(WATERIRRIGATION *data__) {
  ...
  __SET_VAR(data__->TP0.,IN,,__GET_VAR(data__->VALVE,));
  __SET_VAR(data__->TP0.,PT,,__GET_VAR(data__->PULSE,));
  TP_body__(&data__->TP0);
  __SET_VAR(data__->,PUMP,,__GET_VAR(data__->TP0.Q,));
