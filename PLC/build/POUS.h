...
typedef struct {
  ...
  __DECLARE_VAR(BOOL,OUTGOING_VALVE)
  __DECLARE_VAR(BOOL,INCOMING_VALVE)
  __DECLARE_VAR(BOOL,OUTGOING_PUMP)
  __DECLARE_VAR(BOOL,INCOMING_PUMP)
  __DECLARE_VAR(BOOL,TANK_FULL)
  __DECLARE_VAR(BOOL,PULSE)
  __DECLARE_VAR(INT,MAX_TANK_LEVEL)
  __DECLARE_VAR(INT,TANK_LEVEL_VALUE)
  CTD CTD0;
  CTU CTU0;
  TON TON0;
  TOF TOF0;
